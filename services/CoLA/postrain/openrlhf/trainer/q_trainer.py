...
class QTrainer(ABC):
    ...
    def fit(self, args, consumed_samples=0, num_update_steps_per_epoch=None):
        ...
        for epoch in range(start_epoch, self.epochs):
            ...
            self.model.train()
            loss_mean = 0
            for prompts_id_lens, inputs, attention_masks, rewards, infos in self.train_dataloader:
                ...
                for action, source_len in zip(actions, prompts_id_lens):
                    action[:source_len] = self.loss_fn.IGNORE_INDEX
