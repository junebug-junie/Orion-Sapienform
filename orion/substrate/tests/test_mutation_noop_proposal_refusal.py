...
PR #2058 (merged 2026-09-03) stops such a patch being ADOPTED. This module is
the other half: stopping it being GENERATED, so the pipeline does not spend a
proposal, a trial and a decision to arrive at a block.
