...
model_path="/workspace/chengxing/models/meta-llama/Meta-Llama-3.1-8B"
save_path="./checkpoint/${data_type}/intention-3.1-8b-q-train-e100"

deepspeed --include localhost:0,1,2,3,4,5,6,7 --module openrlhf.cli.train_q_intention \
   --max_len 2048 \
   --dataset $data_path \
   --input_key problem \
   --output_key solution \
