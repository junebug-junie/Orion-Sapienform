...
APP_DIR = ROOT / "app"
spec = spec_from_file_location("pad_bus_resilience", APP_DIR / "bus_resilience.py")
assert spec and spec.loader
bus_resilience = module_from_spec(spec)
sys.modules[spec.name] = bus_resilience
spec.loader.exec_module(bus_resilience)
publish_with_reconnect = bus_resilience.publish_with_reconnect
