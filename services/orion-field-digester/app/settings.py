...
class Settings(BaseSettings):
    ...
    # llm_inference_node deltas (orion-llm-gateway's own call outcomes, via
    # substrate-runtime's llm_inference reducer). Off by default so the reducer
    # can be watched in receipts before anything reaches the field.
    enable_llm_inference_field_digestion: bool = Field(
        False,
