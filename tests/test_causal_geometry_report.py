...
def test_divergence_status_categories_are_all_present_and_correct():
    ...
    # "designed_only": execution_pressure and synthetic_cap_pressure channel_map
    ...
    assert any(t.endswith("#synthetic_cap_pressure") for t in designed_only_targets)
...
def test_capability_channel_index_disambiguates_same_edge_different_channels():
    ...
    assert "synthetic_cap_pressure" in index
