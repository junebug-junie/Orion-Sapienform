"""Tests for the equilibrium adapter stub."""
import pytest
...
def test_produces_valid_signal(adapter, norm_ctx):
...
def test_causal_parents_resolved_from_prior(adapter, norm_ctx):
...
def test_missed_parent_note_when_biometrics_absent(adapter, norm_ctx):
