...
class Settings(BaseSettings):
    ...
    topic_foundry_embedding_retry_delay_secs: float = Field(
        0.75,
        validation_alias=AliasChoices("TOPIC_FOUNDRY_EMBEDDING_RETRY_DELAY_SECS"),
    )
    ...
    topic_foundry_hdbscan_cluster_selection_method: str = Field(
        "eom",
        validation_alias=AliasChoices("TOPIC_FOUNDRY_HDBSCAN_CLUSTER_SELECTION_METHOD"),
    )
    ...
    topic_foundry_vectorizer_stop_words: str = Field(
        "english",
        validation_alias=AliasChoices("TOPIC_FOUNDRY_VECTORIZER_STOP_WORDS"),
    )
    ...
    topic_foundry_chat_corpus_output_dir: str = Field(
        "/data/topic-foundry/chat-corpus",
        validation_alias=AliasChoices("TOPIC_FOUNDRY_CHAT_CORPUS_OUTPUT_DIR"),
    )
    topic_foundry_chat_corpus_markdown_path: str = Field(
        "/data/pageindex/chat_episodes/chat_episode_corpus.md",
        validation_alias=AliasChoices("TOPIC_FOUNDRY_CHAT_CORPUS_MARKDOWN_PATH"),
    )
    topic_foundry_chat_corpus_max_rows: int = Field(
        10000,
        validation_alias=AliasChoices("TOPIC_FOUNDRY_CHAT_CORPUS_MAX_ROWS"),
    )
    topic_foundry_chat_corpus_loop_enabled: bool = Field(
        False,
        validation_alias=AliasChoices("TOPIC_FOUNDRY_CHAT_CORPUS_LOOP_ENABLED"),
    )
    topic_foundry_chat_corpus_interval_seconds: int = Field(
        86400,
        validation_alias=AliasChoices("TOPIC_FOUNDRY_CHAT_CORPUS_INTERVAL_SECONDS"),
    )
