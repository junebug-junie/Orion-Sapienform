...
from litgpt.data import DataModule, IntentionLlama_CN
...
def setup(
    ...
    out_dir: Path = Path("out/pretrain/llama-3.1-8b"),
    ...
    train: TrainArgs = TrainArgs(
        ...
        micro_batch_size=1,
        max_tokens=int(1e11),  # 3 trillion
        max_norm=1.0,
        min_lr=4e-6,
        lr=1e-5,
        lr_warmup_steps=100,
    ...
    data = IntentionLlama_CN() #if data is None else data
...
def main(
    ...
    # save_checkpoint(fabric, state, tokenizer_dir, out_dir / "initial" / "lit_model.pth")
...
if __name__ == "__main__":
    ...
    setup(
        ...
        initial_checkpoint_dir=Path("./checkpoints/meta-llama/Meta-Llama-3.1-8B"),
        out_dir=Path("out/pretrain/llama-3.1-8b"),
    ) 
