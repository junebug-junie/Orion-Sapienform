...
- `cosine metric errors` — cosine is implemented via L2-normalize + euclidean by default. Set `TOPIC_FOUNDRY_COSINE_IMPL=generic` to force HDBSCAN generic cosine implementation (slower but avoids tree metrics).
