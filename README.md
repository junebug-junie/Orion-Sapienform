...
| **Circe** | Gigabyte G481-HA0 high-density GPU expansion node; heavy inference workhorse plus training experiments — the sorceress namesake earned | 4× V100 32GB, 2× V100 16GB, 1× P100 16GB → T10 16GB (2026-09-04) | Live |
...
Atlas (DL380 Gen10, 2× V100 16GB) was decommissioned 2026-08-21: its disks were pulled and replaced with Athena's, so Athena now runs from that chassis (and inherited its iLO/PDU position — see `services/orion-biometrics/README.md`); its GPUs, plus Athena's old P100, moved into Circe. That P100 16GB is scheduled to be swapped for a T10 16GB on 2026-09-04 (not yet done as of this writing, 2026-09-01); a 4th V100 32GB has also joined Circe since the Atlas move (see `services/orion-world-model/README.md`), for 7 cards on the node total.
...
Athena — Core Services / Orchestration
  ...
  No GPU (its old P100 16GB moved to Circe, scheduled to be swapped for a
...
Circe — High-Density GPU Expansion Server
  ...
  since), 2× NVIDIA V100 16GB, and (as of this writing, 2026-09-01) 1×
  NVIDIA P100 16GB absorbed from Athena -- scheduled to be swapped for a
  T10 16GB on 2026-09-04. 7 GPUs total.
