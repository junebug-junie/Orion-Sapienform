...
# Determine repo root
# This file is in orion/cognition/hub_gateway/bus_harness.py
# So root is 4 levels up: hub_gateway -> cognition -> orion -> repo_root
...
# Load harness-specific env (first .env, then .env_example)
# Maintain compatibility by looking in scripts/ folder
