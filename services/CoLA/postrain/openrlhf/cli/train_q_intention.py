...
from openrlhf.trainer import QITrainer
...
class QDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return prompt_ids_len, input_token["input_ids"], input_token["attention_mask"], reward_seq, action_seq, info
    ...
    def collate_fn(self, item_list):
        ...
        for prompt_ids_len, input_id, attention_mask, reward, action, info in item_list:
        ...
        return prompt_ids_lens, input_ids, attention_masks, rewards, actions, infos
...
def train(args):
    ...
    target_qmodel.value_head.load_state_dict(qmodel.value_head.state_dict())
    ...
    # for prompts_id_lens, inputs, attention_masks, rewards, actions, infos in eval_dataloader:
        # a = 1
