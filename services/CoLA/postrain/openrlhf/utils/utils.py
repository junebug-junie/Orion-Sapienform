...
def blending_datasets(
    ...
    for i, dataset in enumerate(datasets):
        ...
        if ext == ".py" or (
            ...
            data = load_dataset("json", data_files={"train": os.path.join(dataset, "train.json"), "test": os.path.join(dataset, "test.json")})
            strategy.print(f"loaded dsp dataset {dataset}")
        # local text file
