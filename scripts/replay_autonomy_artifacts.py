...
def main() -> int:
    parser = argparse.ArgumentParser(description="Replay autonomy artifact fixtures and optionally publish them to the Orion bus.")
    ...
    parser.add_argument("--json-out", default=str(DEFAULT_REPORT_DIR / "autonomy_replay_report.json"))
    parser.add_argument("--md-out", default=str(DEFAULT_REPORT_DIR / "autonomy_replay_report.md"))
    ...
    report = harness.run(
        scenarios,
        publish_bus=args.publish_bus and not args.dry_run,
        verify_graphdb=False,
