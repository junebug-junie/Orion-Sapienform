...
# Real-corpus v3/MoC shakedown.
# This uses HyperbolicGPTV2 diagnostics plus MoC per-head geometry.
...
CUDA_VISIBLE_DEVICES="${CUDA_VISIBLE_DEVICES:-0,1}" torchrun --standalone --nproc_per_node="${NPROC_PER_NODE:-2}" \
  ...
  --out_dir "${OUT_DIR:-./runs/fineweb_edu_hypgpt_v3_moc_12l_768d_100m}" \
