...
logger = logging.getLogger("orion.proposal.runtime.main")
...
def build_heartbeat_chassis() -> HeartbeatOnly:
    ...
    every heartbeat_interval_sec. Proposal-runtime had no bus connection of its own before this
    patch (it polls Postgres directly via ProposalRuntimeWorker) -- this chassis is the first
