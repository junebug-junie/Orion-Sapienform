...
POSTGRES_URI = os.getenv("POSTGRES_URI", "sqlite:///collapse.db")
...
if os.getenv("CHRONICLE_MODE") != "cloud":
    chroma_client = PersistentClient(path=os.getenv("CHROMA_PATH", "/home/chrysalis/orion/conjourney-memory"))
